...
def main(MAP_ASCII,COSTS,algorithms,heuristic_number=1):
    ...
    for algorithm in algorithms:
      ...
      #used_viewer=ConsoleViewer()            # V+241222: modo de visualizacion uno a uno graba imagen de paso en disco
      #used_viewer=WebViewer()                # V+241222:modo de visualizacion grafica en linea, crea una pagina interactiva
